...
### Unit Test
You can run the JUnit test [ProcessTest](src/test/java/ru/sawasemykin/ProcessTest.java) in your IDE or using:
...
```bash
java -jar target/camunda-spring-boot-hello.jar
```
...
<!-- Tweet
New @Camunda example: Camunda Spring Boot Application - Spring Boot Application using [Camunda](http://docs.camunda.org). https://github.com/camunda-consulting/code/tree/master/snippets/camunda-spring-boot-hello
-->
